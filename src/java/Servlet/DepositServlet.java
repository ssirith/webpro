...
public class DepositServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (amountInt > 0) {
            ...
            History history = new History(account.getAccountid(),"deposit", amountInt, new java.util.Date(), account.getBalance());
            historyCtrl.create(history);
            request.getServletContext().getRequestDispatcher("/deposit.jsp").forward(request, response);
        }else{
            request.getServletContext().getRequestDispatcher("/deposit.jsp").forward(request, response);
        }
    }
